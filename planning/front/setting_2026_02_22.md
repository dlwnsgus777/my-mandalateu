...
- [x] INFO 섹션 (이용약관, 개인정보처리방침)
  - 법적 문서 초안: `planning/legal/terms_of_service.md`, `planning/legal/privacy_policy.md`
  - 프론트: `Linking.openURL()` 연결 (URL: `LEGAL_URLS` 상수, 배포 시 실제 URL로 교체)
